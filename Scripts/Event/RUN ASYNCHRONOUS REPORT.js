/*
 *  Program : SendReportCustomV1.0.js
 *  Usage   : This script is invoked in Other Event Script
 *  Notes   : This is the standard function including any changes specific to BSEED.
 - systemMailFrom set to AccelaSupport@futurenetgroup.com for BSEED
 * Deployed by Greg Soter, FutureNet Group Inc. 09/16/2016
 */
// ********************************************************************************************************************************
//	Env Paramters Below
// ********************************************************************************************************************************
...
var error = "";
var br = "<BR/>";
var systemMailFrom = "AccelaSupport@futurenetgroup.com";
...
function sendReport() {
    ...
    try {
        aa.print("Step 1.  Get Report Model by ReportName");
        ...
        aa.print("Step 2. Initialize report " + reportInfoResult.getSuccess());
        ...
        aa.print("Step 3. Check permission on report");
        ...
        aa.print("Step 5, Store Report File to harddisk");
        ...
        aa.print("Step 6. Send Report via Email");
