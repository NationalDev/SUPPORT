...
if ((wfTask=="License Issuance" || wfTask=="Licensing Review") && (wfStatus == "Renewed" || wfStatus=="Approved for Renewal"))
{
    ...
    var childLicenseCAPID =  childGetByCapType("LICENSES/*/*/*", getParent(), capId);
...
function isWorkflowDenyForReview(capID, wfTask, stepNum, processID, taskStatus)
{
    ...
    if(result.getSuccess())
    {
        ...
        if (taskItemScriptModel.getTaskDescription().equals(wfTask)
            && ("Licensing Review".equals(wfTask) || "License Issuance".equals(wfTask)) //added an additional renewal task for CoD
