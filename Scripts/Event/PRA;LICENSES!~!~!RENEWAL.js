//*********************************************************************************************************
//	PPA;LICENSES!~!~!RENEWAL.js																	   
//																			Iman Sallam @ City of Detroit  
//		Deploy with the script code and script title below (all caps)									   
//																								           
//					PPA:LICENSES/*/*/RENEWAL	
// 							
//			October 10th, 2017			Revision 1.0
//*********************************************************************************************************
...
try{
	...
	if (isTaskStatus("License Issuance","Issued") && balanceDue <= 0) {
				...
				newLicId = null;
					...
					logDebug(" newLicId1 = " + newLicId +" parent = " + parentCapId);
				...
				if (newLicId==null){
					...
					logDebug(" newLicId2 = " + newLicId +" parent = " + parentCapId);
					
					newLicIdString = newLicId.getCustomID();
	  
					logDebug(" newLicId3 = " + newLicId +" parent = " + parentCapId);
					        ...
					        //******************************** STATIONARY ENGINEER  
												...
												LICENSETYPE = getAppSpecific("License Type",capId);
										  	    ...
										  	    if (LICENSETYPE == "1st Class Station Eng") {
													...
													var rParams = aa.util.newHashMap();
										  			...
										  			runReportAsync("Stationary","Licenses",recordId.getCustomID(),rParams);  
											  		runReport4EmailOrPrint(recordId.getCustomID(),"Stationary",null,rParams,null,null,"Licenses");
										...
										////*********************************** BOILER 
												...
												var rParams = aa.util.newHashMap();
									  			...
									  			runReportAsync("Boiler","Licenses",recordId.getCustomID(),rParams);  
										  		runReport4EmailOrPrint(recordId.getCustomID(),"Boiler",null,rParams,null,null,"Licenses");
