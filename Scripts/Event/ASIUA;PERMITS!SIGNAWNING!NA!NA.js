 ...
 * Record Type:- ASIUA;PERMITS!SIGNAWNING!NA!NA.js
 * 
	...
	for (row in SIGN) {
		if (SIGN[row]["Sign Type"] == "Fixed Awning"){
               ...
               subTotalItem3+= Item3;
                ...
                var baseArea4 = 50, baseFee4 = 122,	aditionalArea4 = 50, additionalFee4 = 46, factor4 = 0, reminder4 = 0, area4 = parseInt(SIGN[row]["Area"]);
				if (area4 <= baseArea4) {
					signFee4 = baseFee4;
                ...
                var baseArea5 = 50, baseFee5 = 80, aditionalArea5 = 50, additionalFee5 = 32, factor5 = 0, reminder5 = 0, area5 = parseInt(SIGN[row]["Area"]);
                if (area5 <= baseArea5) {
                	signFee5 = baseFee5;
                ...
                var baseArea6 = 1000, baseFee6 = 210, aditionalArea6 = 1000, additionalFee6 = 42, factor6 = 0, reminder6 = 0, area6 = parseInt(SIGN[row]["Area"]);
				if (area6 <= baseArea6) {
					signFee6 = baseFee6;
                ...
                var baseArea7 = 100, baseFee7 = 80, aditionalArea7 = 50, additionalFee7 = 26, factor7 = 0, reminder7 = 0, area7 = parseInt(SIGN[row]["Area"]);
                if (area7 <= baseArea7) {
                	signFee7 = baseFee7;
                ...
                var baseArea8 = 100, baseFee8 = 80, aditionalArea8 = 50, additionalFee8 = 26, factor8 = 0, reminder8 = 0, area8 = parseInt(SIGN[row]["Area"]);
                if (area8 <= baseArea8) {
                	signFee8 = baseFee8;
                ...
                var baseArea9 = 50, baseFee9 = 180, aditionalArea9 = 50, additionalFee9 = 32, factor9 = 0, reminder9 = 0, area9 = parseInt(SIGN[row]["Area"]);
                if (area9 <= baseArea9) {
                	signFee9 = baseFee9;
               ...
               subTotalItem11+= Item11;
                ...
                var baseArea12 = 1500, baseFee12 = 400, aditionalArea12 = 500, additionalFee12 = 100, factor12 = 0, reminder12 = 0, area12 = parseInt(SIGN[row]["Area"]);
        	  ...
        	  var baseArea16 = 100, baseFee16 = 80,	aditionalArea16 = 50, additionalFee16 = 26, factor16 = 0, reminder16 = 0, area16 = parseInt(SIGN[row]["Area"]);
