 ...
 * Record Type:- ASIUA;CODEENFORCEMENT!INSPECTIONS!COMMERCIAL!NA.js
 * 
...
if(typeof(SIGN) == "object") {
	for(row in SIGN) {
        if(SIGN[row]["Sign Type"] == "Fixed Awning") {
        	...
        	// subTotalItem4+= Item4;
        	var basearea4 = 300, basefee4 = 58, aditionalarea4 =300, additionalfee4 = 58, factor4 = 0, reminder4 = 0, area4 = 0;
