// Execute the expression only if the selected country is not United States of America.
var countryCode=expression.getValue("CONTACTADDR::countryCode");
if ((countryCode.value != null) &&  (countryCode.value == "US")) {
// Validate address 
...
var Address1 = expression.getValue("CONTACTADDR::addressLine1");
var Address2 = expression.getValue("CONTACTADDR::addressLine1");
var City = expression.getValue("CONTACTADDR::city");
var State = expression.getValue("CONTACTADDR::state");
var Zip = expression.getValue("CONTACTADDR::zip");
var Form = expression.getValue("CONTACTADDR::FORM");
var Validated = expression.getValue("CONTACTADDR::validateFlag");
...
try {
	...
	if (result.Error) {
		...
		Validated.value = "N";
		expression.setReturn(Validated);
