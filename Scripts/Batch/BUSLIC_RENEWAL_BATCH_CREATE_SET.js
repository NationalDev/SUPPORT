	/*------------------------------------------------------------------------------------------------------/
	| Program: LIC_RENEWAL_BATCH_CREATE_SET.js  Trigger: Batch
	| Client:	
	| Version 1.0 - Base Version. 02/05/2014
	|
	| New Program:  BUSLIC_RENEWAL_BATCH_CREATE_SET
	| Client:       DETROIT (City of Detroit, MI)
	| Version 1.1:  Modified Version for BusinessLicense module / appGroup 02/09/2016
	/------------------------------------------------------------------------------------------------------*/
	/*------------------------------------------------------------------------------------------------------/
	|
	...
	//aa.env.setValue("configStdChoice","BUSLIC_RENEWAL_CONFIG"); //V1.1 using specific SC for BusinessLicense renewals
	...
	if (!configStdChoice.length) 
		configStdChoice = "BUSLIC_RENEWAL_CONFIG";
	...
	var fromDate = getParam("searchFromDate");
	var toDate = getParam("searchToDate");
	...
	var appGroup = lookup(configStdChoice, "appGroup");							//   app Group to process {BusinessLicense}	
	var appCategory = lookup(configStdChoice, "appCategory");						//   app category to process {License} //BusinessLicense/*/*/License
