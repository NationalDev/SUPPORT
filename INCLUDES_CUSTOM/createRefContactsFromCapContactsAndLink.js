/**
 * This function can be used as the basis for maintaining a contact-centric database within Accela Automation.
 * @param pCapId
 * @param contactTypeArray
 * @param ignoreAttributeArray
 * @param replaceCapContact
 * @param overwriteRefContact
 * @param refContactExists
 * @returns
 * 
